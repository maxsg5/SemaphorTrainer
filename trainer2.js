...
function GenerateWord() {
    var words = ["brand","arena","punch","angle","fight","cream","smell","unity","drift","aware","proof","adult","flour","coast","fibre","awful","youth","touch","basic","force","enemy","owner","voice","habit","bench","error","hover","trait","cross","equal","attic","begin","swear","salad","scale","robot","track","harsh","creed","mouth"];
